...
### My solve
**Flag:** `pwn.college{wvxWakl20IZj69waEEKDpqU5lap.QXwEjN0wCM3gjNzEzW}`
...
pwn.college{wvxWakl20IZj69waEEKDpqU5lap.QXwEjN0wCM3gjNzEzW}
``` 

### What I learned
- practiced permissions and understood it better

## Challenge 7: Permission setting practice
 
### My solve
**Flag:** `pwn.college{MVjnnsHBBEWwnwbzDRuMQJ4-XAM.QXzETO0wCM3gjNzEzW}`
...
* the world does have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=wx,o=rwx /challenge/pwn
You set the correct permissions!
Round 8 of 8!
...
pwn.college{MVjnnsHBBEWwnwbzDRuMQJ4-XAM.QXzETO0wCM3gjNzEzW}
``` 

### What I learned
- chmod command can also overwrite the old permissions using an = symbol instead of a + or - symbol.
- if a permission needs to be left blank, we can use *-* simply
